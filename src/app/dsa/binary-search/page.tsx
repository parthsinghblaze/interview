...
const BinarySearchVisualizer = () => {
    ...
    useEffect(() => {
        ...
        if (isPlaying || currentStep > 0) {
            ...
            } else if (step.status === 'not_found' && step.description.includes('Scan complete')) {
                playTone(200, 'square', 0.2);
            } else if (step.description.includes('Calculate mid-point')) {
                playTone(400, 'sine', 0.05);
            } else if (step.description.includes('Target must be in')) {
                playTone(300, 'triangle', 0.05); // Cut noise
            }
        }
