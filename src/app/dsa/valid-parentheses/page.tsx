...
const ValidParenthesesVisualizer = () => {
    ...
    useEffect(() => {
        ...
        if (isPlaying || currentStep > 0) {
            ...
            if (step.description.includes('matches top')) {
                // Match Found (Pop)
                playTone(600, 'sine', 0.1);
            } else if (step.description.includes('Pushing')) {
                // Push
                playTone(400, 'triangle', 0.1);
            } else if (step.description.includes('INVALID')) {
                // Error
                playTone(200, 'square', 0.2);
            } else if (step.description.includes('VALID!')) {
                // Success
